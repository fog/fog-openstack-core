  ...
  module OpenStackCore
    class ComputeV2
      class Real
        ...
        # ==== Parameters
        # * options<~Hash>:
        #   * 'security_groups'<~String> - A security_groups object.
        ...
        def create_server(options = {})
          params = Fog::OpenStackCore::Common.whitelist_keys(options,
            %w{security_groups security_group user_data availability_zone
               server imageRef flavorRef networks uuid port fixed_ip name
